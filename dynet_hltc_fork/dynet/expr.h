...
// <b>IMPORTANT</b>
// A boolean type is not a special data type but a special case of a scalar (float) values who is either 0 or 1.

  /**
   * \brief Cast a scalar into boolean scalar, turning non-zero values into 1.
   * \param x The scalar to cast
   * \return The casted scalar
   */
  Expression to_boolean(const Expression& x);
